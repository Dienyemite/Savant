...
Issues live in GitHub Issues for `Dienyemite/Savant`. See `docs/agents/issue-tracker.md`.

### Triage labels

Default role names match the canonical set (needs-triage, needs-info, ready-for-agent, ready-for-human, wontfix). See `docs/agents/triage-labels.md`.
