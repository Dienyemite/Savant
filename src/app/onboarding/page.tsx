...
function OnboardingInner() {
  ...
  const returnTo = searchParams.get("returnTo") ?? "/figma-dashboard";
          ...
          <div className="border border-white/[0.06]">
            ...
            <div className="px-4 pt-4 pb-3">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 border border-white/20 hover:border-white/50 hover:bg-white/5 disabled:opacity-40 transition-colors py-2.5 text-sm text-white/70 hover:text-white"
                style={{ fontFamily: "'Courier New', monospace" }}
              >
                <svg viewBox="0 0 24 24" className="w-4 h-4 shrink-0" aria-hidden="true">
                  ...
                  <path fill="#fff" fillOpacity="0.5" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l3.66-2.84z"/>
                ...
                <span className="text-[10px] tracking-[0.22em] uppercase">Continue with Google</span>
              </button>
            </div>
            ...
            <div className="flex items-center gap-3 px-4 pb-3">
              ...
              <span className="text-[9px] tracking-widest uppercase text-white/20" style={{ fontFamily: "'Courier New', monospace" }}>or</span>
              <div className="flex-1 h-px bg-white/[0.06]" />
            </div>
